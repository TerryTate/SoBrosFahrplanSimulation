...
/**
 * The class MenuBar contains all view elements of the menu bar in the bottom.
 * 
...
public class MenuBar {
	 ...
	 * @return menubar - the menu bar in the bottom
	 */
	public static Menu createMenu(Shell shell) {
		...
		// SelectionListener for the different menuItems
