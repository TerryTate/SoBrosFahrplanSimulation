...
/**
 * This class observes animations for events which are fired when an animation
 * is finished. If there are more animations in an animationqueue the next
...
public class AnimationFinishedQueueObserver implements Observer {
	...
	/**
	 * If an animation is finished we must check if the {@link AnimationFigure}
	 * to which this observer is assigned has more animations in his
	 * animationqueue. If so it starts the next animation.
	 * 
	 * @see Observer
	 */
	@Override
